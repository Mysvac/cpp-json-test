...
if __name__ == "__main__":
    ...
    get_chart("反序列化测试", "加权耗时(微秒)" ,df)
    get_chart("序列化测试", "加权耗时(微秒)", df)
    get_chart("美化序列化测试", "加权耗时(微秒)" ,df)
    get_chart("获取子元素测试", "累计耗时(微秒)",df)
    get_chart("增加子元素测试", "累计耗时(微秒)",df)
    get_chart("删除子元素测试", "累计耗时(微秒)",df)
    get_chart("增删改查加权测试", "加权耗时(微秒)",df)
